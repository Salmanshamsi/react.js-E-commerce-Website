...
const ProductFiltersMain = () => {
  ...
  return (
    <ul className={`w-full flex items-center justify-evenly p-3 `} >
        <li>
        ...
        <li>
            <h1>Search Results : <span className='font-bold' >123</span></h1>
        </li>
        <li>
                <div className="relative">
                <button
                id="dropdownDefault"
                onClick={handleToggle}
                className="border-indigo-400 border hover:text-white text-indigo-400 hover:bg-indigo-400 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                type="button"
                >
                Manual
                <svg
...
export default ProductFiltersMain